...
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.layout("togglesplit"))    -- dwindle only (moved from SUPER+J to free HJKL)
...
-- Vim-style focus with HJKL (SUPER + H/J/K/L)
hl.bind(mainMod .. " + H", hl.dsp.focus({ direction = "left" }))
hl.bind(mainMod .. " + J", hl.dsp.focus({ direction = "down" }))
hl.bind(mainMod .. " + K", hl.dsp.focus({ direction = "up" }))
hl.bind(mainMod .. " + L", hl.dsp.focus({ direction = "right" }))

-- Vim-style resize with HJKL (SUPER+SHIFT + H/J/K/L) - 40px steps, repeating while held
